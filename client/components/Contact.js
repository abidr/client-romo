        ...
        <div className="row justify-content-center">
          <div className="col-xl-6 centered">
            <div className="section-title">
              <h2>Contact Us</h2>
              <p>Wquuntur eaque id dolores nemo numquam iusto natus delectus dolorum, dignissimos aliquid ullam</p>
            </div>
          </div>
        </div>
        <div className="row justify-content-center">
          ...
          <div className="col-xl-4 col-md-4 col-sm-6 col-12">
            <div className="single-contact-box">
              ...
              <p>St. Road 23/659 Allen House Road 23/659 Allen House. USA</p>
            </div>
          </div>
        </div>
        <div className="row justify-content-center">
