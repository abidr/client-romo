...
import { BiArrowBack, BiErrorCircle, BiWallet } from 'react-icons/bi';
        ...
        <div className="row">
          <div className="col">
            <Tab.Container id="left-tabs-example" defaultActiveKey="first">
              <Row>
                <Col sm={3}>
                  <h3 className="mb-30">Make Payment</h3>
                  ...
                  <Tab.Content>
                    <Tab.Pane eventKey="first">
                      <div className="deposit-box basic-card">
                        ...
                        <div className="bttns mt-30">
                          <a href="/#" className="bttn-mid btn-grad">
                            <BiArrowBack />
                            Next
                          </a>
                        </div>
                    ...
                    <Tab.Pane eventKey="second">
                      <div className="basic-card">
                        <h4 className="box-title">Make Payment Logs</h4>
                        <RecentExchange />
                      </div>
                    </Tab.Pane>
                  </Tab.Content>
